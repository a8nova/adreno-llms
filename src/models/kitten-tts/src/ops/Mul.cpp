// Mul.cpp — shared implementation for ALL 511 Mul node(s).
//
// You write the Mul forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Mul, passing the
...
//    102  text_encoder.lstms.9.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.text_encoder.lstms.9.fc.weight_scale
//    103  text_encoder.lstms.7.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.text_encoder.lstms.7.fc.weight_scale
//    104  text_encoder.lstms.5.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.text_encoder.lstms.5.fc.weight_scale
//    105  text_encoder.lstms.3.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.text_encoder.lstms.3.fc.weight_scale
//    106  text_encoder.lstms.1.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.text_encoder.lstms.1.fc.weight_scale
//    107  N.0.norm1.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.0.norm1.fc.weight_scale
//    108  N.0.norm2.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.0.norm2.fc.weight_scale
//    109  N.1.norm1.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.1.norm1.fc.weight_scale
//    110  N.1.norm2.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.1.norm2.fc.weight_scale
//    111  N.2.norm1.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.2.norm1.fc.weight_scale
//    112  N.2.norm2.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.N.2.norm2.fc.weight_scale
//    113  F0.0.norm1.fc.Gemm_MatMul_quant_scales_mul_0  weight_prefix=kmodel.predictor.F0.0.norm1.fc.weight_scale
//   … (+499 more siblings — see .nnport/scaffold_manifest.json)
//
...
//   reference/layers/text_encoder.lstms.9.fc.Gemm_MatMul_quant_scales_mul_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Mul.forward`
...
{
    (void)cl_ctx; (void)weights; (void)queue; (void)input;
    ...
    NNOPT_ERROR_FMT("Mul_forward not yet implemented — class Mul, %zu sibling(s), wp=%s",
                    (size_t)511, wp.c_str());
    return nullptr;
}
}
