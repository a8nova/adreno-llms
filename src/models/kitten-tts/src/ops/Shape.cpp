// Shape.cpp — shared implementation for ALL 135 Shape node(s).
//
// You write the Shape forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Shape, passing the
...
//      1  Shape_1_output_0                          weight_prefix=
//     97  Shape_4_output_0                          weight_prefix=
//    298  Shape_2_output_0                          weight_prefix=
//    504  Shape_8_output_0                          weight_prefix=
//    508  text_encoder_1.Shape_6_output_0           weight_prefix=
//    724  Shape_9_output_0                          weight_prefix=
//    728  Shape_12_output_0                         weight_prefix=
//    729  Shape_11_output_0                         weight_prefix=
//    740  text_encoder_1.Shape_9_output_0           weight_prefix=
//    743  Shape_13_output_0                         weight_prefix=
//    749  text_encoder.Shape_6_output_0             weight_prefix=
//    758  bert.Shape_2_output_0                     weight_prefix=
//   … (+123 more siblings — see .nnport/scaffold_manifest.json)
//
...
//   reference/layers/Shape_1_output_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Shape.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("Shape_forward not yet implemented — class Shape, %zu sibling(s), wp=%s",
                    (size_t)135, wp.c_str());
    return nullptr;
}
}
