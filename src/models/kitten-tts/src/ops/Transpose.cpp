// Transpose.cpp — shared implementation for ALL 126 Transpose node(s).
//
// You write the Transpose forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Transpose, passing the
...
//     80  text_encoder.Transpose_output_0           weight_prefix=
//    371  text_encoder.lstms.11.Transpose_2_output_0  weight_prefix=
//    440  text_encoder.lstms.11.Add_1_output_0      weight_prefix=
//    641  text_encoder.lstms.9.Transpose_2_output_0  weight_prefix=
//    643  text_encoder.lstms.7.Transpose_2_output_0  weight_prefix=
//    645  text_encoder.lstms.5.Transpose_2_output_0  weight_prefix=
//    647  text_encoder.lstms.3.Transpose_2_output_0  weight_prefix=
//    649  text_encoder.lstms.1.Transpose_2_output_0  weight_prefix=
//    713  text_encoder.lstms.9.Add_1_output_0       weight_prefix=
//    714  text_encoder.lstms.7.Add_1_output_0       weight_prefix=
//    715  text_encoder.lstms.5.Add_1_output_0       weight_prefix=
//    716  text_encoder.lstms.3.Add_1_output_0       weight_prefix=
//   … (+114 more siblings — see .nnport/scaffold_manifest.json)
//
...
//   reference/layers/text_encoder.Transpose_output_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Transpose.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("Transpose_forward not yet implemented — class Transpose, %zu sibling(s), wp=%s",
                    (size_t)126, wp.c_str());
    return nullptr;
}
}
