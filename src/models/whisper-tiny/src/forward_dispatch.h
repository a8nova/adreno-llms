...
//
// Model: openai/whisper-tiny (whisper)
// Total nodes: 0
#pragma once
...
// Model type: whisper  weight_prefix: ""
// Layer kinds present: full_attention  (over 4 layers)
...
extern "C" cl_mem op_whisper_full_attention_block(OpenCLContext& cl_ctx,
                                                  Weights& weights,
                                                  cl_command_queue queue,
                                                  cl_mem hidden_in,
                                                  int seq_len,
