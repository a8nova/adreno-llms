...
// reads — the +24% behind this was measured on a DIFFERENT MODEL (SmolLM2-135M) and a DIFFERENT PART
// (Adreno 620, 1 CU). Not re-measured on the Adreno 840 this model targets, and attention is small
// here anyway (48 of 64 blocks are Gated-DeltaNet and use no KV cache at all), so treat the number as
// provenance, not as a result. Generic for any (head_dim % 4 == 0), which holds
