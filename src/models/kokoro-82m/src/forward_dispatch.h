...
//
// Model: hexgrad/Kokoro-82M (unknown)
// Total nodes: 0
#pragma once
...
// Layer kinds present: full_attention  (over 3 layers)
...
extern "C" std::pair<cl_mem, cl_mem> op_text_encoder(OpenCLContext& cl_ctx,
                                                     Weights& weights,
                                                     cl_command_queue queue,
                                                     const std::vector<int32_t>& input_ids,
                                                     int T_chars);
...
extern "C" cl_mem op_duration_predictor(OpenCLContext& cl_ctx,
                                        Weights& weights,
                                        cl_command_queue queue,
                                        cl_mem encoder_hidden,
                                        const std::vector<float>& duration_noise,
                                        int T_chars);

extern "C" int host_compute_durations(cl_command_queue queue,
                                      cl_mem log_durations,
                                      std::vector<int>& out_durations,
                                      float speaking_rate);

extern "C" cl_mem op_length_regulator(OpenCLContext& cl_ctx,
                                      Weights& weights,
                                      cl_command_queue queue,
                                      cl_mem stats,
...
extern "C" cl_mem op_sample_prior(OpenCLContext& cl_ctx,
                                  Weights& weights,
                                  cl_command_queue queue,
                                  cl_mem expanded_stats,
                                  const std::vector<float>& prior_noise,
                                  int T_frames,
                                  float noise_scale);

extern "C" cl_mem op_flow_inverse(OpenCLContext& cl_ctx,
                                 Weights& weights,
                                 cl_command_queue queue,
                                 cl_mem z_prior,
                                 int T_frames);

extern "C" cl_mem op_vocoder(OpenCLContext& cl_ctx,
                             Weights& weights,
                             cl_command_queue queue,
                             cl_mem z_latent,
                             int T_frames);
