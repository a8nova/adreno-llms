// Source: scaffold-owned kernel profiling infra (timing helper, no model math).
// Reference: model_info/transformers_src/modeling_moonshine.py (N/A -- not a ported layer)
#include "profiler.h"
