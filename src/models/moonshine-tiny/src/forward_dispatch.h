...
//
// Model: UsefulSensors/moonshine-tiny (moonshine)
// Total nodes: 0
#pragma once
...
// ── ForwardDispatch: shared audio-input handoff for encoder-decoder ─────
// main.cpp uploads the raw waveform to a cl_mem and hands it to the
// backbone via these setters. The backbone's model_forward_graph reads
// them to run the encoder. Implemented in src/backbone.cpp.
...
// Model type: moonshine  weight_prefix: ""
...
extern "C" cl_mem op_moonshine_full_attention_block(OpenCLContext& cl_ctx,
                                                    Weights& weights,
                                                    cl_command_queue queue,
                                                    cl_mem hidden_in,
                                                    int seq_len,
