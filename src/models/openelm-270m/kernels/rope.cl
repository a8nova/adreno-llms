// Reference: model_info/modeling_openelm.py:55-188 (_rotate_half, _apply_rotary_pos_emb, OpenELMRotaryEmbedding.forward)
...
// dynamic, etc.) — read modeling_openelm.py for the formula and adapt.
