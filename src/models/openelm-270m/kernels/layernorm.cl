// Reference: model_info/modeling_openelm.py:13-53 (OpenELMRMSNorm for eps usage pattern; LayerNorm formula is standard)
// Reference: https://pytorch.org/docs/stable/generated/torch.nn.LayerNorm.html (definition)
// Implements torch.nn.LayerNorm: y = ((x - mean) / sqrt(var + eps)) * weight + bias
