// Reference: (decode fusion is optional; correctness path mirrors unfused PyTorch)
// Reference: model_info/modeling_openelm.py:189-356 (OpenELMMultiHeadCausalAttention.forward)
// Reference: model_info/modeling_openelm.py:359-447 (OpenELMFeedForwardNetwork.forward)
