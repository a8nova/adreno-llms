// Identity.cpp — shared implementation for ALL 1 Identity node(s).
//
...
//     43  mimi_decoder_transformer_output_projs_0   weight_prefix=<none>
//
...
//   reference/layers/mimi_decoder_transformer_output_projs_0_output.bin
