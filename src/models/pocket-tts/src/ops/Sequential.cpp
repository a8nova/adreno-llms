// Sequential.cpp — shared implementation for ALL 1 Sequential node(s).
//
...
//      3  flow_lm_flow_net_final_layer_adaLN_modulation  weight_prefix=<none>
//
...
//   reference/layers/flow_lm_flow_net_final_layer_adaLN_modulation_output.bin
