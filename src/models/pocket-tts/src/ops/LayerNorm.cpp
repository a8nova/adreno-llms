...
//      5  flow_lm_flow_net_final_layer_norm_final   weight_prefix=<none>
//     19  flow_lm_out_norm                          weight_prefix=<none>
//
...
//   reference/layers/flow_lm_flow_net_final_layer_norm_final_output.bin
