// Conv1d.cpp — shared implementation for ALL 1 Conv1d node(s).
//
...
//     47  mimi_quantizer_output_proj                weight_prefix=<none>
//
...
//   reference/layers/mimi_quantizer_output_proj_output.bin
