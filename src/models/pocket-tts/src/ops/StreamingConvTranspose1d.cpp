// StreamingConvTranspose1d.cpp — shared implementation for ALL 4 StreamingConvTranspose1d node(s).
//
// You write the StreamingConvTranspose1d forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class StreamingConvTranspose1d, passing the
...
//     33  mimi_decoder_model_2                      weight_prefix=<none>
//     36  mimi_decoder_model_5                      weight_prefix=<none>
//     39  mimi_decoder_model_8                      weight_prefix=<none>
//     49  mimi_upsample_convtr                      weight_prefix=<none>
//
...
//   reference/layers/mimi_decoder_model_2_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> StreamingConvTranspose1d.forward`
...
extern "C" {
cl_mem StreamingConvTranspose1d_forward(
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("StreamingConvTranspose1d_forward not yet implemented — class StreamingConvTranspose1d, %zu sibling(s), wp=%s",
                    (size_t)4, wp.c_str());
    return nullptr;
}
}
