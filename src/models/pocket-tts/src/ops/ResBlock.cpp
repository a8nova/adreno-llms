// ResBlock.cpp — shared implementation for ALL 6 ResBlock node(s).
//
// You write the ResBlock forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class ResBlock, passing the
...
//      9  flow_lm_flow_net_res_blocks_0             weight_prefix=<none>
//     10  flow_lm_flow_net_res_blocks_1             weight_prefix=<none>
//     11  flow_lm_flow_net_res_blocks_2             weight_prefix=<none>
//     12  flow_lm_flow_net_res_blocks_3             weight_prefix=<none>
//     13  flow_lm_flow_net_res_blocks_4             weight_prefix=<none>
//     14  flow_lm_flow_net_res_blocks_5             weight_prefix=<none>
//
...
//   reference/layers/flow_lm_flow_net_res_blocks_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> ResBlock.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("ResBlock_forward not yet implemented — class ResBlock, %zu sibling(s), wp=%s",
                    (size_t)6, wp.c_str());
    return nullptr;
}
}
