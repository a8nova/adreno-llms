// StreamingTransformerLayer.cpp — shared implementation for ALL 6 StreamingTransformerLayer node(s).
//
// You write the StreamingTransformerLayer forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class StreamingTransformerLayer, passing the
...
//     21  flow_lm_transformer_layers_0              weight_prefix=<none>
//     22  flow_lm_transformer_layers_1              weight_prefix=<none>
//     23  flow_lm_transformer_layers_2              weight_prefix=<none>
//     24  flow_lm_transformer_layers_3              weight_prefix=<none>
//     25  flow_lm_transformer_layers_4              weight_prefix=<none>
//     26  flow_lm_transformer_layers_5              weight_prefix=<none>
//
...
//   reference/layers/flow_lm_transformer_layers_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> StreamingTransformerLayer.forward`
...
extern "C" {
cl_mem StreamingTransformerLayer_forward(
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("StreamingTransformerLayer_forward not yet implemented — class StreamingTransformerLayer, %zu sibling(s), wp=%s",
                    (size_t)6, wp.c_str());
    return nullptr;
}
}
