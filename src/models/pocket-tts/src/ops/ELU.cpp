// ELU.cpp — shared implementation for ALL 4 ELU node(s).
//
// You write the ELU forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class ELU, passing the
...
//     30  mimi_decoder_model_10                     weight_prefix=<none>
//     32  mimi_decoder_model_1                      weight_prefix=<none>
//     35  mimi_decoder_model_4                      weight_prefix=<none>
//     38  mimi_decoder_model_7                      weight_prefix=<none>
//
...
//   reference/layers/mimi_decoder_model_10_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> ELU.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("ELU_forward not yet implemented — class ELU, %zu sibling(s), wp=%s",
                    (size_t)4, wp.c_str());
    return nullptr;
}
}
