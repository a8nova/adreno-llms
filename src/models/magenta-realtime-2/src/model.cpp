// Reference: reference/forward_graph.json (MLX trace) and docs/MODALITY_MUSIC.md
// Auto-generated graph-mode model implementation for google/magenta-realtime-2.
// Backbone: model_forward_graph() in src/backbone.cpp; traced node count in reference/forward_graph.json
//
