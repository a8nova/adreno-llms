...
// Fused 3-output GEMV: ya=Wa@x, yb=Wb@x, yc=Wc@x in one dispatch at M=1.
// Falls back to 3 separate pytorch_linear calls when M>1 or image2d unavailable.
...
// Fused 2-output GEMV: ya=Wa@x, yb=Wb@x in one dispatch at M=1.
