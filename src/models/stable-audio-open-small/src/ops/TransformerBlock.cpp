// TransformerBlock.cpp — shared implementation for ALL 16 TransformerBlock node(s).
//
// You write the TransformerBlock forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class TransformerBlock, passing the
...
//     40  transformer_layers_0                      weight_prefix=<none>
//     66  transformer_layers_1                      weight_prefix=<none>
//     92  transformer_layers_2                      weight_prefix=<none>
//    118  transformer_layers_3                      weight_prefix=<none>
//    144  transformer_layers_4                      weight_prefix=<none>
//    170  transformer_layers_5                      weight_prefix=<none>
//    196  transformer_layers_6                      weight_prefix=<none>
//    222  transformer_layers_7                      weight_prefix=<none>
//    248  transformer_layers_8                      weight_prefix=<none>
//    274  transformer_layers_9                      weight_prefix=<none>
//    300  transformer_layers_10                     weight_prefix=<none>
//    326  transformer_layers_11                     weight_prefix=<none>
...
//   reference/layers/transformer_layers_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> TransformerBlock.forward`
...
extern "C" {
cl_mem TransformerBlock_forward(
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("TransformerBlock_forward not yet implemented — class TransformerBlock, %zu sibling(s), wp=%s",
                    (size_t)16, wp.c_str());
    return nullptr;
}
}
