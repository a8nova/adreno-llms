// Sequential.cpp — shared implementation for ALL 19 Sequential node(s).
//
// You write the Sequential forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Sequential, passing the
...
//      3  to_cond_embed                             weight_prefix=<none>
//      7  to_global_embed                           weight_prefix=<none>
//     12  to_timestep_embed                         weight_prefix=<none>
//     37  transformer_layers_0_ff_ff                weight_prefix=<none>
//     63  transformer_layers_1_ff_ff                weight_prefix=<none>
//     89  transformer_layers_2_ff_ff                weight_prefix=<none>
//    115  transformer_layers_3_ff_ff                weight_prefix=<none>
//    141  transformer_layers_4_ff_ff                weight_prefix=<none>
//    167  transformer_layers_5_ff_ff                weight_prefix=<none>
//    193  transformer_layers_6_ff_ff                weight_prefix=<none>
//    219  transformer_layers_7_ff_ff                weight_prefix=<none>
//    245  transformer_layers_8_ff_ff                weight_prefix=<none>
//   … (+7 more siblings — see .nnport/scaffold_manifest.json)
//
...
//   reference/layers/to_cond_embed_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Sequential.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("Sequential_forward not yet implemented — class Sequential, %zu sibling(s), wp=%s",
                    (size_t)19, wp.c_str());
    return nullptr;
}
}
