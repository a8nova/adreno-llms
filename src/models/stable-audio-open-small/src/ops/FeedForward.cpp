// FeedForward.cpp — shared implementation for ALL 16 FeedForward node(s).
//
// You write the FeedForward forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class FeedForward, passing the
...
//     38  transformer_layers_0_ff                   weight_prefix=<none>
//     64  transformer_layers_1_ff                   weight_prefix=<none>
//     90  transformer_layers_2_ff                   weight_prefix=<none>
//    116  transformer_layers_3_ff                   weight_prefix=<none>
//    142  transformer_layers_4_ff                   weight_prefix=<none>
//    168  transformer_layers_5_ff                   weight_prefix=<none>
//    194  transformer_layers_6_ff                   weight_prefix=<none>
//    220  transformer_layers_7_ff                   weight_prefix=<none>
//    246  transformer_layers_8_ff                   weight_prefix=<none>
//    272  transformer_layers_9_ff                   weight_prefix=<none>
//    298  transformer_layers_10_ff                  weight_prefix=<none>
//    324  transformer_layers_11_ff                  weight_prefix=<none>
...
//   reference/layers/transformer_layers_0_ff_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> FeedForward.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("FeedForward_forward not yet implemented — class FeedForward, %zu sibling(s), wp=%s",
                    (size_t)16, wp.c_str());
    return nullptr;
}
}
