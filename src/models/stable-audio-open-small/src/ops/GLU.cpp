// GLU.cpp — shared implementation for ALL 16 GLU node(s).
//
// You write the GLU forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class GLU, passing the
...
//     33  transformer_layers_0_ff_ff_0              weight_prefix=<none>
//     59  transformer_layers_1_ff_ff_0              weight_prefix=<none>
//     85  transformer_layers_2_ff_ff_0              weight_prefix=<none>
//    111  transformer_layers_3_ff_ff_0              weight_prefix=<none>
//    137  transformer_layers_4_ff_ff_0              weight_prefix=<none>
//    163  transformer_layers_5_ff_ff_0              weight_prefix=<none>
//    189  transformer_layers_6_ff_ff_0              weight_prefix=<none>
//    215  transformer_layers_7_ff_ff_0              weight_prefix=<none>
//    241  transformer_layers_8_ff_ff_0              weight_prefix=<none>
//    267  transformer_layers_9_ff_ff_0              weight_prefix=<none>
//    293  transformer_layers_10_ff_ff_0             weight_prefix=<none>
//    319  transformer_layers_11_ff_ff_0             weight_prefix=<none>
...
//   reference/layers/transformer_layers_0_ff_ff_0_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> GLU.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("GLU_forward not yet implemented — class GLU, %zu sibling(s), wp=%s",
                    (size_t)16, wp.c_str());
    return nullptr;
}
}
