// SiLU.cpp — shared implementation for ALL 19 SiLU node(s).
//
// You write the SiLU forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class SiLU, passing the
...
//      1  to_cond_embed_1                           weight_prefix=<none>
//      5  to_global_embed_1                         weight_prefix=<none>
//     10  to_timestep_embed_1                       weight_prefix=<none>
//     32  transformer_layers_0_ff_ff_0_act          weight_prefix=<none>
//     58  transformer_layers_1_ff_ff_0_act          weight_prefix=<none>
//     84  transformer_layers_2_ff_ff_0_act          weight_prefix=<none>
//    110  transformer_layers_3_ff_ff_0_act          weight_prefix=<none>
//    136  transformer_layers_4_ff_ff_0_act          weight_prefix=<none>
//    162  transformer_layers_5_ff_ff_0_act          weight_prefix=<none>
//    188  transformer_layers_6_ff_ff_0_act          weight_prefix=<none>
//    214  transformer_layers_7_ff_ff_0_act          weight_prefix=<none>
//    240  transformer_layers_8_ff_ff_0_act          weight_prefix=<none>
...
//   reference/layers/to_cond_embed_1_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> SiLU.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("SiLU_forward not yet implemented — class SiLU, %zu sibling(s), wp=%s",
                    (size_t)19, wp.c_str());
    return nullptr;
}
}
