// Attention.cpp — shared implementation for ALL 32 Attention node(s).
//
// You write the Attention forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Attention, passing the
...
//     20  transformer_layers_0_self_attn            weight_prefix=<none>
//     28  transformer_layers_0_cross_attn           weight_prefix=<none>
//     46  transformer_layers_1_self_attn            weight_prefix=<none>
//     54  transformer_layers_1_cross_attn           weight_prefix=<none>
//     72  transformer_layers_2_self_attn            weight_prefix=<none>
//     80  transformer_layers_2_cross_attn           weight_prefix=<none>
//     98  transformer_layers_3_self_attn            weight_prefix=<none>
//    106  transformer_layers_3_cross_attn           weight_prefix=<none>
//    124  transformer_layers_4_self_attn            weight_prefix=<none>
//    132  transformer_layers_4_cross_attn           weight_prefix=<none>
//    150  transformer_layers_5_self_attn            weight_prefix=<none>
//    158  transformer_layers_5_cross_attn           weight_prefix=<none>
//   … (+20 more siblings — see .nnport/scaffold_manifest.json)
//
...
//   reference/layers/transformer_layers_0_self_attn_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Attention.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("Attention_forward not yet implemented — class Attention, %zu sibling(s), wp=%s",
                    (size_t)32, wp.c_str());
    return nullptr;
}
}
