// Identity.cpp — shared implementation for ALL 80 Identity node(s).
//
// You write the Identity forward() math ONCE here. backbone.cpp calls
// this function once per traced node of class Identity, passing the
...
//     21  transformer_layers_0_self_attn_scale      weight_prefix=<none>
//     29  transformer_layers_0_cross_attn_scale     weight_prefix=<none>
//     34  transformer_layers_0_ff_ff_1              weight_prefix=<none>
//     36  transformer_layers_0_ff_ff_3              weight_prefix=<none>
//     39  transformer_layers_0_ff_scale             weight_prefix=<none>
//     47  transformer_layers_1_self_attn_scale      weight_prefix=<none>
//     55  transformer_layers_1_cross_attn_scale     weight_prefix=<none>
//     60  transformer_layers_1_ff_ff_1              weight_prefix=<none>
//     62  transformer_layers_1_ff_ff_3              weight_prefix=<none>
//     65  transformer_layers_1_ff_scale             weight_prefix=<none>
//     73  transformer_layers_2_self_attn_scale      weight_prefix=<none>
//     81  transformer_layers_2_cross_attn_scale     weight_prefix=<none>
...
//   reference/layers/transformer_layers_0_self_attn_scale_output.bin
...
//    `// Reference: model_info/transformers_src/<file>.py:<lines> Identity.forward`
    ...
    const char* weight_prefix)
{
    ...
    NNOPT_ERROR_FMT("Identity_forward not yet implemented — class Identity, %zu sibling(s), wp=%s",
                    (size_t)80, wp.c_str());
    return nullptr;
}
}
