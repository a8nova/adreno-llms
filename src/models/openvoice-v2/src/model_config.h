...
// Source: /Users/alazarshenkute/.nnopt/repos/OpenVoice/openvoice/models.py:SynthesizerTrn.__init__ and weight shapes in weights/model.meta.json
constexpr int HIDDEN_SIZE = 192;
constexpr int VOCAB_SIZE = 192;
constexpr int SPEC_CHANNELS = 513;
constexpr int GIN_CHANNELS = 256;
constexpr int UPSAMPLE_INITIAL_CHANNEL = 512;
constexpr int NUM_UPSAMPLES = 4;
constexpr int NUM_RESBLOCKS = 12;
