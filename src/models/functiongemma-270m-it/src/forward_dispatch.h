...
//
// Model: functiongemma-270m-it (Gemma3ForCausalLM)
// Total nodes: 313
#pragma once
...
// Model type: gemma3_text  weight_prefix: ""
// Layer kinds present: sliding_attention, full_attention  (over 18 layers)
...
extern "C" cl_mem op_gemma3_text_sliding_attention_block(OpenCLContext& cl_ctx,
                                                         Weights& weights,
                                                         cl_command_queue queue,
                                                         cl_mem hidden_in,
                                                         int seq_len,
...
extern "C" cl_mem op_gemma3_text_full_attention_block(OpenCLContext& cl_ctx,
                                                      Weights& weights,
                                                      cl_command_queue queue,
                                                      cl_mem hidden_in,
                                                      int seq_len,
