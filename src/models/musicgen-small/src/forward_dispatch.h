...
//
// Model: facebook/musicgen-small (musicgen)
// Total nodes: 0
#pragma once
...
// Model type: musicgen_decoder  weight_prefix: "decoder."
// Layer kinds present: full_attention  (over 24 layers)
...
extern "C" cl_mem op_musicgen_decoder_full_attention_block(OpenCLContext& cl_ctx,
                                                           Weights& weights,
                                                           cl_command_queue queue,
                                                           cl_mem hidden_in,
                                                           int seq_len,
