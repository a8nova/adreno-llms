...
private:
    ...
    // SentencePiece unigram piece scores (log-probs), indexed by id. Present
    // when the vocab file carries the optional trailing 'SCOR' section —
    // enables true unigram (Viterbi) encoding instead of greedy matching.
