...
def main():
            ...
            if src_model is not None:
                ...
                if layer_container is not None:
                    ...
                    manifest = {
                        ...
                        "_nnport_capture_version": "2026-06-03-encdec-generic-forward-v4-waveform-capture",
                        "_framework": "source",
                ...
                ref_tokens = {
                    ...
                    "script_version": "2026-06-03-encdec-generic-forward-v4-waveform-capture",
    ...
    manifest["_nnport_capture_version"] = "2026-06-03-encdec-generic-forward-v4-waveform-capture"
