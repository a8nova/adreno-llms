#!/bin/bash
# Build script for depth-anything/Depth-Anything-V2-Small-hf
...
# with -DNNOPT_DTYPE=fp16. fp16 is the shipped default; set fp32 for build/.
...
if [ "$NNOPT_DTYPE" = "fp16" ]; then
    BIN_NAME="Depth_Anything_V2_Small_hf_inference_fp16"
else
    BIN_NAME="Depth_Anything_V2_Small_hf_inference"
fi
echo ""
echo "==================================="
